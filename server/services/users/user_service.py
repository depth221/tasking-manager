...
from server.models.dtos.user_dto import UserDTO, UserOSMDTO, UserFilterDTO, UserSearchQuery, UserSearchDTO, \
    UserStatsDTO, UserValidatorRoleRequestDTO
...
from server.models.postgis.user import User, UserRole, MappingLevel, UserValidatorRoleRequest, UserValidatorRoleRequestStatus
...
class UserValidatorRoleRequestService:
    ...
    def get_by_id_as_dto(validator_role_request_id: int) -> UserValidatorRoleRequestDTO:
        validator_role_request = UserValidatorRoleRequestService.get_by_id(validator_role_request_id)
        return validator_role_request.as_dto()

    @staticmethod
    def create(validator_role_dto: UserValidatorRoleRequestDTO) -> UserValidatorRoleRequestDTO():
        validator_role_dto = UserValidatorRoleRequest.create_from_dto(validator_role_dto)
    ...
    def update(dto: UserValidatorRoleRequestDTO) -> UserValidatorRoleRequestDTO:
        ...
        if dto.status == UserValidatorRoleRequestStatus.ACCEPT.name:
            ...
            message.message = f'Your validation role request application has been accepted'
