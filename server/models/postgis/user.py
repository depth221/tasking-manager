...
from server.models.dtos.user_dto import UserDTO, UserMappedProjectsDTO, MappedProject, UserFilterDTO, Pagination, \
    UserSearchQuery, UserSearchDTO, ProjectParticipantUser, ListedUser, UserValidatorRoleRequestDTO
from server.models.postgis.licenses import License, users_licenses_table
from server.models.postgis.project_info import ProjectInfo
from server.models.postgis.statuses import MappingLevel, ProjectStatus, UserRole, UserValidatorRoleRequestStatus
...
class UserValidatorRoleRequest(db.Model):
    ...
    response_user = db.relationship(User, foreign_keys=[response_user_id], backref='validation_form_responses')
    ...
    @classmethod
    def create_from_dto(cls, dto: UserValidatorRoleRequestDTO) -> UserValidatorRoleRequestDTO:
        role_request = cls()
